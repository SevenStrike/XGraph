...
[![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/SevenStrike/XGraph)](https://github.com/SevenStrike/XGraph/releases)
...
### 🎯 此版本为 “ScriptableObject数据驱动” 版本，如果您需要 “Json数据驱动” 版本请选择 main 分支 ！！
...
- xNode_Base.cs: 视觉节点的基类
- xAction_Base.cs: 数据节点的基类
- xAction_Asset.cs: 行为树资源
### 📦 设计亮点
---
#### ⚙️ 可视化与代码分离
