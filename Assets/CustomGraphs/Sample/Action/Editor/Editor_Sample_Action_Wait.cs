namespace SevenStrikeModules.XGraph
{
    ...
    [CustomEditor(typeof(Sample_Action_Wait))]
    public class Editor_Sample_Action_Wait : Editor_ActionNode_Base
    {
        private Sample_Action_Wait actionScript;
        ...
        public override void GetTargetScript()
        {
            ...
            actionScript = target as Sample_Action_Wait;
        }
