namespace SevenStrikeModules.XGraph
{
    ...
    [CustomEditor(typeof(Sample_Action_Start))]
    public class Editor_Sample_Action_Start : Editor_ActionNode_Base
    {
        private Sample_Action_Start actionScript;
        ...
        public override void GetTargetScript()
        {
            ...
            actionScript = target as Sample_Action_Start;
        }
