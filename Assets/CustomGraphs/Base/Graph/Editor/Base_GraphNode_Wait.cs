namespace SevenStrikeModules.XGraph
{
    ...
    public class Base_GraphNode_Wait : VNode_Base
    {
        public override void Initialize(xg_GraphView graphView, Vector2 pos = default, ActionNode_Base data = null)
        {
            ...
            // 加入变量端口
            port_in.Add(new xGraph_NodePort("delay", typeof(Variable_Float), Port.Capacity.Single));
            InputPort_Set(port_in);

            List<xGraph_NodePort> port_out = new List<xGraph_NodePort>();
            // 加入行为端口
            port_out.Add(new xGraph_NodePort("out", typeof(ActionNode_Base), Port.Capacity.Multi));
