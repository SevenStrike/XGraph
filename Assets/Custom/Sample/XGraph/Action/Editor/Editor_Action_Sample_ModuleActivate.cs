namespace SevenStrikeModules.XGraph
{
    ...
    [CustomEditor(typeof(Action_Sample_ModuleActivate))]
    public class Editor_Action_Sample_ModuleActivate : Editor_ActionNode_Composite
    {
        /// <summary>
        /// 目标对象
        /// </summary>
        private Action_Sample_ModuleActivate activator;
        /// <summary>
        /// 节点属性
        /// </summary>
        ...
        public override void GetTargetScript()
        {
            ...
            activator = target as Action_Sample_ModuleActivate;
        }
        /// <summary>
        /// 获取序列化属性
        /// </summary>
        ...
        public override Foldout Folder_Extensions(VisualElement root)
        {
            ...
            {
                // 克隆父物体的行为数据
                Action_Sample_ModuleActivate s_source = (Action_Sample_ModuleActivate)source;
                // 克隆后的行为数据
                Action_Sample_ModuleActivate s_clone = (Action_Sample_ModuleActivate)clone;
