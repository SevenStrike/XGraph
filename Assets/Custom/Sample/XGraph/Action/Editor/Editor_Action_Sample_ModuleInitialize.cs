namespace SevenStrikeModules.XGraph
{
    ...
    [CustomEditor(typeof(Action_Sample_ModuleInitialize))]
    public class Editor_Action_Sample_ModuleInitialize : Editor_ActionNode_Start
    {
        /// <summary>
        /// 目标对象
        /// </summary>
        private Action_Sample_ModuleInitialize start;
        /// <summary>
        /// 节点属性
        /// </summary>
        ...
        public override void GetTargetScript()
        {
            ...
            start = target as Action_Sample_ModuleInitialize;
        }
        /// <summary>
        /// 获取序列化属性
        /// </summary>
        ...
        public override Foldout Folder_Extensions(VisualElement root)
        {
            ...
            {
                // 克隆父物体的行为数据
                Action_Sample_ModuleInitialize s_clone = clone as Action_Sample_ModuleInitialize;
                // 克隆后的行为数据
                Action_Sample_ModuleInitialize s_source = source as Action_Sample_ModuleInitialize;
