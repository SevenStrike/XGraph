namespace SevenStrikeModules.XGraph
{
    ...
    [CustomEditor(typeof(Action_GetLight))]
    public class Editor_Action_GetLight : Editor_ActionNode_Composite
    {
        private Action_GetLight mainlight;
        ...
        public override void GetTargetScript()
        {
            ...
            mainlight = target as Action_GetLight;
        }
        /// <summary>
        /// 获取序列化属性
        /// </summary>
