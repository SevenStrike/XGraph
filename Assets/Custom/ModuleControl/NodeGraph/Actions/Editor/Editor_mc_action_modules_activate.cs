namespace SevenStrikeModules.XGraph
{
    ...
    [CustomEditor(typeof(mc_action_modules_activate))]
    public class Editor_mc_action_modules_activate : Editor_xAction_Composite
    {
        /// <summary>
        /// 目标对象
        /// </summary>
        private mc_action_modules_activate activator;
        /// <summary>
        /// 节点序列化属性
        /// </summary>
        ...
        public override void GetTargetScript()
        {
            ...
            activator = target as mc_action_modules_activate;
        }
        /// <summary>
        /// 获取序列化属性
        /// </summary>
