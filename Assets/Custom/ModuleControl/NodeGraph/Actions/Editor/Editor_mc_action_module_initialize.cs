namespace SevenStrikeModules.XGraph
{
    ...
    [CustomEditor(typeof(mc_action_module_initialize))]
    public class Editor_mc_action_module_initialize : Editor_xAction_Start
    {
        /// <summary>
        /// 目标对象
        /// </summary>
        private mc_action_module_initialize start;
        /// <summary>
        /// 节点序列化属性
        /// </summary>
        ...
        public override void GetTargetScript()
        {
            ...
            start = target as mc_action_module_initialize;
        }
        /// <summary>
        /// 获取序列化属性
        /// </summary>
        ...
        public override Foldout Folder_Extensions(VisualElement root)
        {
            ...
            {
                // 克隆父物体的行为数据
                mc_action_module_initialize s_clone = clone as mc_action_module_initialize;
                // 克隆后的行为数据
                mc_action_module_initialize s_source = source as mc_action_module_initialize;
