namespace SevenStrikeModules.XGraph
{
    ...
    public class mc_node_property_light : xNode_Property
    {
        mc_action_property_light property_light;
        ...
        public override void Initialize(xg_GraphView graphView, Vector2 pos = default, xAction_Base data = null)
        {
            ...
            property_light = data as mc_action_property_light;
        }
        ...
        public override void On_Nodes_Duplicated(List<DuplicateNodeData> list)
        {
            ...
            {
                if (node.DuplicatedNode is mc_node_property_light cur)
                {
                    // 找到克隆的父物体行为节点
                    mc_node_property_light source = graphView.FindNode(node.SourceNodeGuid) as mc_node_property_light;
