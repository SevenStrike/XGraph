namespace SevenStrikeModules.XGraph
{
    ...
    public class mc_node_light_control : xNode_Base
    {
        mc_action_light_control mainlight;
        ...
        public override void Initialize(xg_GraphView graphView, Vector2 pos = default, xAction_Base data = null)
        {
            ...
            mainlight = data as mc_action_light_control;
        }
        ...
        public override void On_Nodes_Duplicated(List<DuplicateNodeData> list)
        {
            ...
            {
                if (node.DuplicatedNode is mc_node_light_control cur)
                {
                    // 找到克隆的父物体行为节点
                    mc_node_light_control source = graphView.FindNode(node.SourceNodeGuid) as mc_node_light_control;
