namespace SevenStrikeModules.XGraph
{
    ...
    [CustomEditor(typeof(ActionNode_Relay))]
    public class Editor_ActionNode_Relay : Editor_ActionNode_Base
    {
        private ActionNode_Relay actionScript;
        ...
        public override void GetTargetScript()
        {
            ...
            actionScript = target as ActionNode_Relay;
        }
        /// <summary>
        /// 获取序列化属性
        /// </summary>
