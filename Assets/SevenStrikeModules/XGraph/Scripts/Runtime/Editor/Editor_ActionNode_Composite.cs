namespace SevenStrikeModules.XGraph
{
    ...
    [CustomEditor(typeof(ActionNode_Composite), true)]
    public class Editor_ActionNode_Composite : Editor_ActionNode_Base
    {
        private ActionNode_Composite actionScript;
        ...
        public override void GetTargetScript()
        {
            ...
            actionScript = target as ActionNode_Composite;
        }
        /// <summary>
        /// 获取序列化属性
        /// </summary>
