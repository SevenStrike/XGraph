...
namespace SevenStrikeModules.XGraph
{
    ...
    public class xNode_Label : Node
    {
        ...
        /// 当选中节点时的委托事件
        /// </summary>
        public Action<xNode_Label> OnSelectedNode;
        /// <summary>
        /// 当选中节点时的委托事件
        /// </summary>
        public Action<xNode_Label> OnUnSelectedNode;
        /// <summary>
        /// 当粗体值改变时
        /// </summary>
        ...
        public virtual void Initialize(xg_GraphView graphView, Vector2 pos = default, xLabelData data = null)
        {
            // 指定可调整大小
        ...
        public virtual void Draw_Top()
        {
            ...
            AppendElement(xNodeContainerType.TopContainer, labelContentlabel);
            AppendElement(xNodeContainerType.TopContainer, labelContentInput);
            #endregion
        }
        ...
        private void Btn_font_color_clicked()
        {
            ...
            void ApplyColor(Color pickedColor)
            {
                ...
                {
                    if (selectable is xNode_Label node)
                    {
