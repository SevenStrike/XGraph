namespace SevenStrikeModules.XGraph
{
    ...
    public class xNode_Stick : Node
    {
        ...
        /// 当选中节点时的委托事件
        /// </summary>
        public Action<xNode_Stick> OnSelectedNode;
        /// <summary>
        /// 当选中节点时的委托事件
        /// </summary>
        public Action<xNode_Stick> OnUnSelectedNode;
        #region 节点信息
        /// <summary>
        /// 节点标题
        /// </summary>
        ...
        /// 节点携带的数据
        /// </summary>
        public xStickData StickData { get; set; }
        ...
        public virtual void Initialize(xg_GraphView graphView, Vector2 pos = default, xStickData data = null)
        {
            // 指定可调整大小
        ...
        public virtual void Draw_Top()
        {
            ...
            AppendElement(xNodeContainerType.TopContainer, stickContentlabel);
            AppendElement(xNodeContainerType.TopContainer, stickContentInput);
            #endregion
        }
        ...
        public virtual void Draw_Title()
        {
            ...
            AppendElement(xNodeContainerType.TitleContainer, icon);
            AppendElement(xNodeContainerType.TitleContainer, stickTitlelabel);
            AppendElement(xNodeContainerType.TitleContainer, stickTitleInput);
            AppendElement(xNodeContainerType.TitleContainer, element);
        }
